 ...
 */
const unsigned int VK_LBUTTON    =0x01;
const unsigned int VK_RBUTTON    =0x02;
const unsigned int VK_CANCEL     =0x03;
const unsigned int VK_MBUTTON    =0x04; /* NOT contiguous with L & RBUTTON */

const unsigned int VK_BACK       =0x08;
const unsigned int VK_TAB        =0x09;

const unsigned int VK_CLEAR      =0x0C;
const unsigned int VK_RETURN     =0x0D;

const unsigned int VK_SHIFT      =0x10;
const unsigned int VK_CONTROL    =0x11;
const unsigned int VK_MENU       =0x12;
const unsigned int VK_PAUSE      =0x13;
const unsigned int VK_CAPITAL    =0x14;


const unsigned int VK_ESCAPE     =0x1B;

const unsigned int VK_SPACE      =0x20;
const unsigned int VK_PRIOR      =0x21;
const unsigned int VK_NEXT       =0x22;
const unsigned int VK_END        =0x23;
const unsigned int VK_HOME       =0x24;
const unsigned int VK_LEFT       =0x25;
const unsigned int VK_UP         =0x26;
const unsigned int VK_RIGHT      =0x27;
const unsigned int VK_DOWN       =0x28;
const unsigned int VK_SELECT     =0x29;
const unsigned int VK_PRINT      =0x2A;
const unsigned int VK_EXECUTE    =0x2B;
const unsigned int VK_SNAPSHOT   =0x2C;
const unsigned int VK_INSERT     =0x2D;
const unsigned int VK_DELETE     =0x2E;
const unsigned int VK_HELP       =0x2F;

/* VK_0 thru VK_9 are the same as ASCII '0' thru '9' (0x30 - 0x39) */
/* VK_A thru VK_Z are the same as ASCII 'A' thru 'Z' (0x41 - 0x5A) */

const unsigned int VK_LWIN       =0x5B;
const unsigned int VK_RWIN       =0x5C;
const unsigned int VK_APPS       =0x5D;

const unsigned int VK_NUMPAD0    =0x60;
const unsigned int VK_NUMPAD1    =0x61;
const unsigned int VK_NUMPAD2    =0x62;
const unsigned int VK_NUMPAD3    =0x63;
const unsigned int VK_NUMPAD4    =0x64;
const unsigned int VK_NUMPAD5    =0x65;
const unsigned int VK_NUMPAD6    =0x66;
const unsigned int VK_NUMPAD7    =0x67;
const unsigned int VK_NUMPAD8    =0x68;
const unsigned int VK_NUMPAD9    =0x69;
const unsigned int VK_MULTIPLY   =0x6A;
const unsigned int VK_ADD        =0x6B;
const unsigned int VK_SEPARATOR  =0x6C;
const unsigned int VK_SUBTRACT   =0x6D;
const unsigned int VK_DECIMAL    =0x6E;
const unsigned int VK_DIVIDE     =0x6F;
const unsigned int VK_F1         =0x70;
const unsigned int VK_F2         =0x71;
const unsigned int VK_F3         =0x72;
const unsigned int VK_F4         =0x73;
const unsigned int VK_F5         =0x74;
const unsigned int VK_F6         =0x75;
const unsigned int VK_F7         =0x76;
const unsigned int VK_F8         =0x77;
const unsigned int VK_F9         =0x78;
const unsigned int VK_F10        =0x79;
const unsigned int VK_F11        =0x7A;
const unsigned int VK_F12        =0x7B;
const unsigned int VK_F13        =0x7C;
const unsigned int VK_F14        =0x7D;
const unsigned int VK_F15        =0x7E;
const unsigned int VK_F16        =0x7F;
const unsigned int VK_F17        =0x80;
const unsigned int VK_F18        =0x81;
const unsigned int VK_F19        =0x82;
const unsigned int VK_F20        =0x83;
const unsigned int VK_F21        =0x84;
const unsigned int VK_F22        =0x85;
const unsigned int VK_F23        =0x86;
const unsigned int VK_F24        =0x87;

const unsigned int VK_NUMLOCK    =0x90;
const unsigned int VK_SCROLL     =0x91;
 ...
 */
const unsigned int VK_LSHIFT     =0xA0;
const unsigned int VK_RSHIFT     =0xA1;
const unsigned int VK_LCONTROL   =0xA2;
const unsigned int VK_RCONTROL   =0xA3;
const unsigned int VK_LMENU      =0xA4;
const unsigned int VK_RMENU      =0xA5;

#if(WINVER >= 0x0400)
const unsigned int VK_PROCESSKEY =0xE5;
#endif /* WINVER >= 0x0400 */

const unsigned int VK_ATTN       =0xF6;
const unsigned int VK_CRSEL      =0xF7;
const unsigned int VK_EXSEL      =0xF8;
const unsigned int VK_EREOF      =0xF9;
const unsigned int VK_PLAY       =0xFA;
const unsigned int VK_ZOOM       =0xFB;
const unsigned int VK_NONAME     =0xFC;
const unsigned int VK_PA1        =0xFD;
const unsigned int VK_OEM_CLEAR  =0xFE;
